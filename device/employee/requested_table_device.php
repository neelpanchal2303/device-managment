...
<?php
  ...
  $dragobj   = new drag;
  $data = $dragobj -> requested_dragdata('device');
   ...
   $n =1 ;
    ...
    <tr id="trhover">
        ...
        <td><a id='<?php echo $row['id']; ?>'  class='edit' name='edit' ><span> <button id='<?php echo $row['id']; ?>' class=" notify btn-success rounded"> NOTIFY </button></span></a></td>
...
// AJAX Request
      $.ajax({
        url: 'notify_device.php',
        type: 'POST',
        data: { id:requestid },
        success: function(response){

          //window.location.href="requested_table_device.php";
