...
$search_result2 = $deviceobj -> dragdata('device_record');
...
<tr class="text-white">
  ...
  <th scope="col"><?php echo '<a class="up" href="track_record.php?sort=ASC&colunm=request_time&valueToSearch='.$_SESSION['search'].'" name="type_up"  >↑</a>Request time<a class="type_down" href="track_record.php?sort=DESC&colunm=request_time&valueToSearch='.$_SESSION['search'].'">↓</a>'?></th>
  <th scope="col"><?php echo '<a class="up" href="track_record.php?sort=ASC&colunm=assigned_time&valueToSearch='.$_SESSION['search'].'" name="type_up" >↑</a>Assigned time<a class="type_down" href="track_record.php?sort=DESC&colunm=assigned_time&valueToSearch='.$_SESSION['search'].'">↓</a>'?></th>
  <th scope="col"><?php echo '<a class="up" href="track_record.php?sort=ASC&colunm=return_time&valueToSearch='.$_SESSION['search'].'" name="type_up" >↑</a>Return time<a class="type_down" href="track_record.php?sort=DESC&colunm=return_time&valueToSearch='.$_SESSION['search'].'">↓</a>'?></th>
  <th scope="col"><?php echo '<a class="up" href="track_record.php?sort=ASC&colunm=reject_time&valueToSearch='.$_SESSION['search'].'" name="type_up" >↑</a>Reject time<a class="type_down" href="track_record.php?sort=DESC&colunm=reject_time&valueToSearch='.$_SESSION['search'].'">↓</a>'?></th>
...
<ul class="pagination" >
      ...
      $search = $_SESSION['search'];
        ...
        if(isset($_SESSION['search']))
        {
          ...
          $sql = "SELECT COUNT(*) FROM device_record inner join device on device.id=device_record.device_id inner join user on user.id=device_record.employee_id WHERE email = '$email' AND CONCAT(`request_time`,`assigned_time`,`return_time`,`reject_time`) LIKE '%".$_SESSION['search']."%'   ";
        }
        ...
        for ($i=1; $i<=$total_pages; $i++) {
            if ($i==$pn) {
                ...
                $pagLink .= "<li><a id='pagelink' href='track_record.php?page=".$i."&colunm=".$colunm."&sort=".$sort."&valueToSearch=".$search."'>".$i."</a></li>";  
            }
        }  
