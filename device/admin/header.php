  ...
  <div class="offcanvas-body" style="padding-left:10% ;">
    <ul class="navbar-nav ms-auto ">
      <li class="nav-item me-1">
        <a class="nav-link " href="mainpage1.php">Home</a>
      </li>
      <li class="nav-item me-1">
        <a class="nav-link  h" aria-current="page" href="device.php">Device</a>
      </li>
      <li class="nav-item me-1">
        <a class="nav-link " href="employee.php">employee</a>
      </li>
      <li class="nav-item me-1">
        <a class="nav-link " href="device_record_table.php">Requested Devices</a>
      </li>
      <!-- <li class="nav-item me-1">
        <a class="nav-link " href="assigned_device_table.php">Assigned Devices</a>
      </li> -->
      <li class="nav-item me-1">
        <a class="nav-link " href="track_record.php">History of Devices</a>
      </li>
      <li>
